...
class UrlWindow
{
    ...
    protected function getUrlSlider($onEachSide)
    {
        ...
        // If the current pages is very close to the beginning of the pages range, we will
        ...
        // If the current pages is close to the ending of the pages range we will just get
    ...
    /**
     * Get the pages range for the current pages window.
     *
     * @param  int  $onEachSide
     * @return array
     */

...
trait InteractsWithPages
{
    ...
    /**
     * All of the stored inputs for the current pages.
     *
     * @var array
     */
    protected $inputs = [];
    ...
    /**
     * All of the stored uploads for the current pages.
     *
     * @var array
     */
    protected $uploads = [];
    ...
    /**
     * Clean the crawler and the subcrawlers values to reset the pages context.
     *
     * @return void
     */
    ...
    /**
     * Clear the inputs for the current pages.
     *
     * @return $this
     */
    ...
    /**
     * Assert that the current pages matches a given URI.
     *
     * @param  string  $uri
     * @return $this
     */
    protected function seePageIs($uri)
    {
        ...
        $this->assertEquals(
            $uri, $this->currentUri, "Did not land on expected pages [{$uri}].\n"
        );
    ...
    /**
     * Assert that the current pages matches a given named route.
     *
     * @param  string  $route
     * @param  array  $parameters
     * @return $this
    ...
    /**
     * Assert that a given pages successfully loaded.
     *
     * @param  string  $uri
    ...
    /**
     * Narrow the test content to a specific area of the pages.
     *
    ...
    /**
     * Assert that an element is present on the pages.
     *
    ...
    /**
     * Assert that an element is not present on the pages.
     *
     * @param  string  $selector
     * @param  array  $attributes
     * @return $this
    ...
    /**
     * Assert that a given link is seen on the pages.
     *
     * @param  string $text
    ...
    /**
     * Assert that a given link is not seen on the pages.
     *
     * @param  string  $text
     * @param  string|null  $url
     * @return $this
    ...
    /**
     * Uncheck a checkbox on the pages.
     *
     * @param  string  $element
     * @return $this
     */
    ...
    /**
     * Attach a file to a form field on the pages.
     *
    ...
    /**
     * Submit a form on the pages with the given input.
     *
     * @param  string  $buttonText
     * @param  array  $inputs
     * @param  array  $uploads
    ...
    /**
     * Get the form from the pages with the given submit button text.
     *

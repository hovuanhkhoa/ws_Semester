...
class UrlMatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $coll = new RouteCollection();
        $coll->add('test', new Route('/{pages}.{_format}', array('pages' => 'index', '_format' => 'html')));

        $matcher = new UrlMatcher($coll, new RequestContext());
        $this->assertEquals(array('pages' => 'my-pages', '_format' => 'xml', '_route' => 'test'), $matcher->match('/my-pages.xml'));
    }
    ...
    {
        $coll = new RouteCollection();
        $coll->add('test', new Route('/{pages}.{_format}'));
        $matcher = new UrlMatcher($coll, new RequestContext());

        $this->assertEquals(array('pages' => 'index', '_format' => 'mobile.html', '_route' => 'test'), $matcher->match('/index.mobile.html'));
    }
    ...
    {
        $coll = new RouteCollection();
        $coll->add('test', new Route('/{pages}.{_format}', array(), array('_format' => 'html|xml')));
        $matcher = new UrlMatcher($coll, new RequestContext());

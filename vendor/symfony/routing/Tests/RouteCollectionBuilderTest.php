...
class RouteCollectionBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFlushSetsDetailsOnChildrenRoutes()
    {
        ...
        $routes->add('/blogs/{pages}', 'listAction', 'blog_list')
        ...
        $routes
            ...
            ->setHost('symfony.com')
            ->setCondition('request.query.get("pages")==1')
        ...
        $this->assertEquals(1, $actualListRoute->getDefault('pages'));
        ...
        $this->assertEquals('request.query.get("pages")==1', $actualEditRoute->getCondition());
